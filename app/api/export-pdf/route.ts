  ...
  try {
    ...
    const fullHtml = `
      ...
      <head>
        ...
        <style>
          /* 🚨 DYNAMIC PAGE SIZING: Locks the PDF hardware dimensions */
          @page {
          ...
          /* --- DYNAMIC CSS INJECTION BASED ON CONTENT TYPE --- */
          ${typeId === 'social' ? `
            /* 🔒 SOCIAL POST MULTI-CARD CONFIGURATION */
            [data-type="card"] { 
              ...
              /* 🚨 THE MULTI-PAGE FIX: Force a hardware page break after every card */
              page-break-after: always !important;
              break-after: page !important;
              page-break-inside: avoid !important;
            }
            
            /* Prevent a blank white page at the very end */
          ...
          ` : typeId === 'landing' ? `
            /* 🚨 LANDING PAGE PDF FIX: Forbid page breaks from shattering the layout */
            * { 
          ...
          ` : `
            ...
            [data-type="card"] { 
                ...
                /* 🚨 FIX 1: Removed background: white !important so inline colors work! */
                /* 🚨 FIX 2: Removed the 1px solid border! */
    ...
    // 🚨 Wait 500ms to ensure Tailwind finishes processing before PDF triggers
