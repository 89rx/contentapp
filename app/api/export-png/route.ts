    ...
    const fullHtml = `
      ...
      <head>
        ...
        <style>
          ...
          ${typeId === 'social' ? `
            [data-type="card"] { display: flex !important; flex-direction: column !important; padding: 0 !important; background: white; overflow: hidden !important; height: ${pageH}px !important; width: ${pageW}px !important; }
          ...
          ` : typeId === 'landing' ? `
            [data-type="card"] { position: relative !important; height: ${pageH}px !important; background-color: #0f172a !important; border-radius: 0 !important; overflow: hidden !important; display: flex !important; flex-direction: column !important; padding: 0 !important; width: ${pageW}px !important; }
          ...
          ` : `
            [data-type="card"] { width: ${pageW}px !important; background: white !important; padding: 4rem 5rem !important; margin: 0 auto 2rem auto !important; border-radius: 1rem !important; border: 1px solid #e5e7eb !important; box-sizing: border-box !important; }
